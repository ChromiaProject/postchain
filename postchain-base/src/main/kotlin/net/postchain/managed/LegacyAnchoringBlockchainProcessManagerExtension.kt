 ...
 * NOTE: No longer supports subnodes, kept for legacy chains
 */
class LegacyAnchoringBlockchainProcessManagerExtension(private val postchainContext: PostchainContext) : BlockchainProcessManagerExtension {
