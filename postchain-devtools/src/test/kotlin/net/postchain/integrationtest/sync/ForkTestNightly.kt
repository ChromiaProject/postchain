...
class ForkTestNightly : ManagedModeTest() {
    ...
    fun testForkSignerCrossFetch() {
        ...
        nodeDataSource.addExtraReplica(ChainUtil.ridOf(c1.chain), XPeerID(KeyPairHelper.pubKey(1)))
...
//    }
    ...
    private fun ancestor(index: Int, blockchain: Long): String {
        return "${XPeerID(KeyPairHelper.pubKey(index))}:${ChainUtil.ridOf(blockchain)}"
    }
