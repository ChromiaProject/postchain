...
class CommandBlockchainReplicaAdd : CliktCommand(name = "add") { 
    override fun help(context: Context) = "Add info to system about blockchain replicas. To be used to sync this node."
