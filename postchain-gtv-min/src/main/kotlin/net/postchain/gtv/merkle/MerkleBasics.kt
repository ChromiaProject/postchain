 ...
 * --------
 */
public object MerkleBasics {

    /**
     * Prefixes are put in front of the hash, after the hash value has been calculated
     */
    public const val HASH_PREFIX_NODE: Byte = 0
    public const val HASH_PREFIX_LEAF: Byte = 1

    public const val UNKNOWN_SIZE_IN_BYTE: Int = -101
     ...
     */
    public fun hashingFun(bArr: ByteArray, digester: Digester?): Hash {
        if (digester == null) {
