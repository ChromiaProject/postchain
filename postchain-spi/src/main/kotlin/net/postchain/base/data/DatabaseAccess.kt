...
interface DatabaseAccess {
    ...
    fun getContainerIids(ctx: AppContext): Map<String, Int>
    fun removeContainerIid(ctx: AppContext, name: String)
    ...
    fun removeAllBlockchainSpecificTables(ctx: EContext, excludeTables: List<String> = emptyList())
    ...
    fun streamStates(ctx: EContext, prefix: String, height: Long, startN: Long, op: (stateData: StateData?) -> Boolean)
