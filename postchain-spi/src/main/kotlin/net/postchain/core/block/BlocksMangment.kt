...
interface BlockQueries : Shutdownable {
    ...
    fun getSnapshotData(height: Long, contextId: Long, permanent: Boolean, datumIdFrom: Long, maxDataSize: Long, maxTime: Long): CompletionStage<Pair<List<SnapshotDatum>, List<Pair<Long, Long>>>>
    fun getSnapshotDataHashes(height: Long, contextId: Long, permanent: Boolean, gaps: List<Pair<Long, Long>>): CompletionStage<List<Pair<Long, Hash>>>
    fun getSnapshotRangeProof(height: Long, contextId: Long, datumIdFrom: Long, datumIdTo: Long): CompletionStage<RangeProof>
