...
class MerkleTreeBuilderTest : TestCase() {
    ...
    fun testBuildMerkleTree_3Leafs() {
        ...
        val l12 = ds.hash(leaf1, leaf2)
        val l34 = ds.hash(leaf3, EMPTY_HASH)
    ...
    fun testBuildMerkleTree_5Leafs() {
        ...
        val l12 = ds.hash(leaf1, leaf2)
        val l34 = ds.hash(leaf3, leaf4)
        val l56 = ds.hash(leaf5, EMPTY_HASH)
        val l1234 = ds.hash(l12, l34)
        val expected = ds.hash(l1234, l56)
