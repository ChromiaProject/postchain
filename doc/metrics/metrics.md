...
| operations,result=success               | timer   | Successful operations.                                                                                                                                                                                               | chainIID, blockchainRID, operationName                          |
| operations,result=failure               | timer   | Failed operations.                                                                                                                                                                                                   | chainIID, blockchainRID, operationName                          |
| operationCorrectness,result=success     | timer   | Successful operation correctness checks.                                                                                                                                                                             | chainIID, blockchainRID, operationName                          |
| operationCorrectness,result=failure     | timer   | Failed operation correctness checks.                                                                                                                                                                                 | chainIID, blockchainRID, operationName                          |
