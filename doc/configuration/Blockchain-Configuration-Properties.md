...
| `async_query_queue_capacity`           | Maximum size of the queue for async queries, 0 means no support for async queries.                                                                                                                      | int           |                    | 0       |
| `async_query_timeout_seconds`          | Timeout for async queries in seconds.                                                                                                                                                                   | int           |                    | 1 hour  |
| `query_timeout_seconds`                | Timeout for sync queries in seconds. Zero or negative value disables the timeout.                                                                                                                       | int           |                    | 1 min   |
| `async_query_result_retention_seconds` | How many seconds to keep the result of an async query after it is completed.                                                                                                                            | int           |                    | 1 hour  |
